...
class SpeciesViewModelTest {
    ...
    @Test
    fun loadSpecies_setsReadyStateWhenListRequestSucceeds() = runTest {
    ...
    @Test
    fun loadSpecies_setsUserFacingErrorWhenListRequestFails() = runTest {
        val viewModel = SpeciesViewModel(
    ...
    @Test
    fun loadSpeciesDetail_setsDetailAndHotspotReadyStatesWhenRequestsSucceed() = runTest {
    ...
    @Test
    fun loadSpeciesDetail_setsIndependentErrorsWhenDetailAndHotspotRequestsFail() = runTest {
        val viewModel = SpeciesViewModel(
    ...
    @Test
    fun openCandidate_loadsListWhenSpeciesStateIsIdle() = runTest {
        var listLoadCount = 0
        val viewModel = SpeciesViewModel(
            loadSpeciesList = { _, _ ->
                listLoadCount += 1
    ...
    private fun speciesDetailFixture() = SpeciesDetailDto(
        id = "lynx",
        commonName = "삵",
        scientificName = "Prionailurus bengalensis",
        category = "mammal",
    ...
    private fun hotspotFixture() = HotspotDto(
        id = 1,
        name = "DMZ 생태길",
        region = "강원",
        latitude = 38.1,

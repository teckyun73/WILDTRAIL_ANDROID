...
sealed interface SpeciesUiState {
    ...
    data class Ready(val species: List<SpeciesSummaryDto>) : SpeciesUiState
...
sealed interface SpeciesDetailUiState {
    ...
    data class Ready(val detail: SpeciesDetailDto) : SpeciesDetailUiState
...
sealed interface HotspotUiState {
    ...
    data class Ready(val hotspots: List<HotspotDto>) : HotspotUiState
    data class Error(val message: String) : HotspotUiState
}
